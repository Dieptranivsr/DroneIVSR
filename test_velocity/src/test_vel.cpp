...
int main(int argc, char **argv)
{
    ...
    ROS_INFO_STREAM("POSITION A:");
	std::cout << "x : ";	std::cin >> pose_A.pose.position.x;
	std::cout << "y : ";	std::cin >> pose_A.pose.position.y;
	std::cout << "z : ";	std::cin >> pose_A.pose.position.z;
    ROS_INFO_STREAM("POSITION B:"); 
    std::cout << "x : ";	std::cin >> pose_B.pose.position.x;
    std::cout << "y : ";	std::cin >> pose_B.pose.position.y;
    std::cout << "z : ";	std::cin >> pose_B.pose.position.z;
    std::cout << "Flight time: "; std::cin >> _timer;
    ...
    if (mode == 4)
    {
    	...
    	ROS_WARN("You've not yet finished your work.");
    return 0;
}

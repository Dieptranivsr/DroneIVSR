...
class Commander:
    def __init__(self):
        ...
        rate = rospy.Rate(20)
        self.position_target_pub = rospy.Publisher('td/set_pose/position', PoseStamped, queue_size=10)
        self.yaw_target_pub = rospy.Publisher('td/set_pose/orientation', Float32, queue_size=10)
        self.custom_activity_pub = rospy.Publisher('td/set_activity/type', String, queue_size=10)

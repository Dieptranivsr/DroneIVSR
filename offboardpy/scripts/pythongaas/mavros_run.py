...
class Px4Controller:
    ...
    def __init__(self):
        ...
        self.set_target_position_sub = rospy.Subscriber("td/set_pose/position", PoseStamped, self.set_target_position_callback)
        self.set_target_yaw_sub = rospy.Subscriber("td/set_pose/orientation", Float32, self.set_target_yaw_callback)
        self.custom_activity_sub = rospy.Subscriber("td/set_activity/type", String, self.custom_activity_callback)
